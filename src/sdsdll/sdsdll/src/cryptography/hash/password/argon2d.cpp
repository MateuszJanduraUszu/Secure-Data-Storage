...
template _SDSDLL_API struct argon2d_traits<char>;
template _SDSDLL_API struct argon2d_traits<unsigned char>;
template _SDSDLL_API struct argon2d_traits<wchar_t>;
_SDSDLL_END
