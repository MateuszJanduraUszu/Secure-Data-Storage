...
_SDSDLL_BEGIN
// FUNCTION TEMPLATE chacha20_poly1305_traits::bytes_count
template <class _Elem>
_NODISCARD constexpr typename chacha20_poly1305_traits<_Elem>::size_type
    chacha20_poly1305_traits<_Elem>::bytes_count(const size_type _Count) noexcept {
    return _Count + _Tag_size; // always plain text length + 16-byte tag
}

// FUNCTION TEMPLATE chacha20_poly1305_traits::chars_count
template <class _Elem>
_NODISCARD constexpr typename chacha20_poly1305_traits<_Elem>::size_type
    chacha20_poly1305_traits<_Elem>::chars_count(const size_type _Count) noexcept {
    return _Count - _Tag_size; // always cipher text length - 16-byte tag
}

// FUNCTION TEMPLATE chacha20_poly1305_traits::encrypt
template <class _Elem>
_NODISCARD constexpr bool chacha20_poly1305_traits<_Elem>::encrypt(
    ...
    if (::EVP_EncryptInit_ex(
        _Proxy._Ctx, ::EVP_chacha20_poly1305(), nullptr, _Key.get(), _Iv.get()) == 0) {
        return false;
    }
...
// FUNCTION TEMPLATE chacha20_poly1305_traits::decrypt
template <class _Elem>
_NODISCARD constexpr bool chacha20_poly1305_traits<_Elem>::decrypt(char_type* const _Buf,
...
template struct _SDSDLL_API chacha20_poly1305_traits<char>;
template struct _SDSDLL_API chacha20_poly1305_traits<unsigned char>;
template struct _SDSDLL_API chacha20_poly1305_traits<wchar_t>;
_SDSDLL_END
